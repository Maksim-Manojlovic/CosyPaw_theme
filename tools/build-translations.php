...
$sr_source = array(
	...
	'Svaki po %s pojedinačno — ili ih spoji u paket i uštedi.'                                => array( 'Each one %s individually — or bundle them and save.', 'Каждый по %s по отдельности — или собери в набор и сэкономь.' ),
	...
	'Cela družina na okupu'                                                                   => array( 'The whole crew together', 'Вся компания в сборе' ),
	...
	'Hiljade ručica već se suše uz CosyPaw — evo šta kažu njihovi vlasnici.'                  => array( 'Thousands of little hands already dry with CosyPaw — here is what their owners say.', 'Тысячи ручек уже сохнут с CosyPaw — вот что говорят их владельцы.' ),
	'Prosečna ocena'                                                                          => array( 'Average rating', 'Средняя оценка' ),
	'Prodatih peškiriča'                                                                      => array( 'Towels sold', 'Продано полотенец' ),
	'Preporučuje prijateljima'                                                                => array( 'Recommend to friends', 'Рекомендуют друзьям' ),
