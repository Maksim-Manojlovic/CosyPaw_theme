...
$sr_source = array(
	...
	'Dečiji peškiri od mikrofibera, ručno rađeni, sa alkom za kačenje i preko 20 motiva. Sastavi svoj paket, plaćanje pouzećem, dostava 2–4 dana širom Srbije.' => array( 'Handmade children’s microfiber towels with a hanging loop, in over 20 designs. Build your own bundle, cash on delivery, 2–4 day shipping across Serbia.', 'Детские полотенца из микрофибры ручной работы, с петелькой, более 20 мотивов. Собери свой набор, оплата при получении, доставка 2–4 дня по всей Сербии.' ),
	...
	'Dečiji peškir od mikrofibera, motiv %s'                                                  => array( 'Children’s microfiber towel, %s design', 'Детское полотенце из микрофибры, мотив «%s»' ),
	...
	'%d jedinstvenih motiva'                                                                  => array( '%d unique designs', '%d уникальных мотивов' ),
	...
	'Dečiji peškiri sa motivima životinja'                                                    => array( 'Children’s towels with animal designs', 'Детские полотенца с мотивами животных' ),
	...
	'Nežni cvetni motivi za mirniji, prirodni kutak.'                                         => array( 'Gentle floral designs for a calmer, natural corner.', 'Нежные цветочные мотивы для спокойного, природного уголка.' ),
	'Peškiri u torbi'                                                                         => array( 'Towels in a bag', 'Полотенца в сумочке' ),
	'Još peškira'                                                                             => array( 'More towels', 'Ещё полотенца' ),
	'Zašto motivi'                                                                            => array( 'Why designs', 'Зачем мотивы' ),
	'Dečija higijena kroz igru'                                                               => array( 'Children’s hygiene through play', 'Детская гигиена через игру' ),
	'Dečiji peškiri sa motivima životinja su mnogo više od običnog tekstila za kupatilo. Kad dete vidi omiljenog drugara kako ga čeka na kuki, baš na njegovoj visini, pranje ruku prestaje da bude obaveza i postaje igra.' => array( 'Children’s towels with animal designs are much more than ordinary bathroom textiles. When a child sees a favourite friend waiting on the hook, right at their height, washing hands stops being a chore and becomes a game.', 'Детские полотенца с мотивами животных — это гораздо больше, чем обычный текстиль для ванной. Когда ребёнок видит любимого друга, который ждёт его на крючке прямо на его высоте, мытьё рук перестаёт быть обязанностью и становится игрой.' ),
	...
	'dečijih peškira sa motivima životinja'                                                   => array( 'children’s towels with animal designs', 'детских полотенец с мотивами животных' ),
	'Ako tražiš personalizovane poklone za decu, set sastavljaš sam: izaberi motive po ukusu deteta iz naše kolekcije %s, zalogajčića i cvetića.' => array( 'If you are looking for personalised gifts for children, you put the set together yourself: choose designs to the child’s taste from our collection of %s, treats and flowers.', 'Если ищешь персонализированные подарки для детей, набор собираешь сам: выбери мотивы по вкусу ребёнка из нашей коллекции %s, вкусняшек и цветочков.' ),
	...
	'Ručno rađeni peškiri sa alkom za kačenje — %d motiva koji grle tvoje kupatilo.'         => array( 'Handmade towels with a hanging loop — %d designs that hug your bathroom.', 'Полотенца ручной работы с петелькой — %d мотивов, что обнимают твою ванную.' ),
	'%1$d+%2$d GRATIS'                                                                        => array( '%1$d+%2$d FREE', '%1$d+%2$d В ПОДАРОК' ),
	'besplatna dostava'                                                                       => array( 'free shipping', 'бесплатная доставка' ),
